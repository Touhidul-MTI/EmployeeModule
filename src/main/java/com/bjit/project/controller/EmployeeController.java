...
public class EmployeeController {
	...
	String filePath = "E:\\BJIT_work\\J2EE\\EmployeeModule\\src\\main\\resources\\static\\employee-photo";
	// String filePath =
	// "/home/hp/eclipse-workspace/BlackANT/src/main/resources/static/product-images/";
	...
	public EmployeeJsonResponse createEmployee(@ModelAttribute @Valid Employee employee, BindingResult result) {
		...
		if (result.hasErrors()) {
			...
			if (existEmployee != null) {
				...
				//previous profile picture exists
				if(!existEmployee.getProfilePicture().equals("") && existEmployee.getProfilePicture() != null) {
					
					// new photo added
					if (!createdFileName.equals("")) {
						//System.out.println(existEmployee.getEmployeeName() + " pic to delete");
	...
	public void removePreviousProfilePicture(String existingProfilePicture) {
		File fileToDelete = new File(filePath + "\\" + existingProfilePicture);
